...
urlpatterns = [
    ...
    path(
        'bus-reservation-history-details',
        views.bus_reservation_history_details,
        name='bus-reservation-history-details',
    ),
    ...
    path(
        ...
        views.flight_reservation_details,
        name='flight-reservation-details',
    ),
    path(
        'flight-reservation-history-details',
        views.flight_reservation_history_details,
        name='flight-reservation-history-details',
    ),
    ...
    path(
        ...
        views.train_reservation_details,
        name='train-reservation-details',
    ),
    path(
        'train-reservation-history-details',
        views.train_reservation_history_details,
        name='train-reservation-history-details',
    ),
]
