...
from apps.bus.models import BusReservation
from apps.core.models import Bus, Flight, Train
from apps.flight.models import FlightReservation
from apps.train.models import TrainReservation
