...
urlpatterns = [
    ...
    path('check-train-availability/',views.check_train_availability,name='check-train-availability'),
    ...
    path('cancel-train-reservation/',views.cancel_train_reservation,name='cancel-train-reservation'),
